...
export function Room() {
  ...
  async function handleSendQuestion(event: FormEvent) {
    ...
    if (!user) {
      throw new Error ('Para enviar uma pergunta você precisa estar logado');
    }
  ...
  async function handeleLikeQuestion(questionId:string, likedId: string | undefined) {
    if (likedId){
            ...
            {questions.map(question => {
              return (
                ...
                >
                  ...
                  onClick={() => handeleLikeQuestion(question.id, question.likedId)}
                  >
